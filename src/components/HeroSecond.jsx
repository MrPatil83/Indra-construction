...
function HeroSecond() {
  return (
    ...
    >
      ...
      <motion.div
        className="relative w-full lg:w-1/2 md:p-4 flex flex-col items-center"
        initial={{ opacity: 0, x: -100 }} // Start from left side with 0 opacity
      ...
      <motion.div
        className="w-full lg:w-[45%] pb-3 flex items-center"
        initial={{ opacity: 0, x: 100 }} // Start from right side with 0 opacity
        whileInView={{ opacity: 1, x: 0 }} // Fade in and move to the center
        transition={{ duration: 2 }}
        viewport={{ once: true, amount: 0.5 }}
      >
            ...
            <div className="space-y-4 mb-6">
              <div className="flex flex-col items-center md:flex-row md:items-start ">
                <img
                  src="https://demo.themagnifico.net/construction-demolition-services/wp-content/themes/construction-demolition-services-pro/assets/images/about-us/about-image1.png"
                  alt="Our Mission"
                  className="w-16 h-16 p-3 object-cover rounded-full mr-4 border border-gray-100 shadow-xl mb-4 md:mb-0"
                />
                <div>
                  <h4 className="text-xl font-semibold">Our Mission</h4>
                  <p className="text-gray-600">
                    We provide the best solutions for engineering, construction,
                    and management.
                  </p>
                </div>
              </div>
